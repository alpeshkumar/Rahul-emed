...
(function(t) {
    function e(e) {
        ...
        return this.filter("select").each(function() {
            var n=t(this), s=n.data("tokenize2"), r="object"==typeof e&&e;
            s||n.data("tokenize2", new o(this, r)), i.push(n.data("tokenize2"))
        }
        ), i.length>1?i:i[0]
    }
    var o=function(e, i) {
        this.control=!1, this.element=t(e), this.options=t.extend( {}
        , o.DEFAULTS, i), this.options.tabIndex=-1===this.options.tabIndex?0: this.options.tabIndex, this.options.sortable=1!==this.options.tokensMaxItems&&this.options.sortable, this.bind(), this.trigger("tokenize:load")
    }
    , i= {
        BACKSPACE: 8, TAB: 9, ENTER: 13, ESCAPE: 27, ARROW_UP: 38, ARROW_DOWN: 40, CTRL: 17, MAJ: 16
    }
    ;
    o.VERSION="1.0", o.DEBOUNCE=null, o.DEFAULTS= {
        tokensMaxItems: 0, tokensAllowCustom: !1, dropdownMaxItems: 10, searchMinLength: 0, searchFromStart: !0, searchHighlight: !0, displayNoResultsMessage: !1, noResultsMessageText: 'No results mached "%s"', delimiter: ",", dataSource: "select", debounce: 0, placeholder: !1, sortable: !1, zIndexMargin: 500, tabIndex: 0
    }
    , o.prototype.trigger=function(t, e, o, i) {
        this.element.trigger(t, e, o, i)
    }
    , o.prototype.bind=function() {
        this.element.on("tokenize:load", {}
        , t.proxy(function() {
            this.init()
        }
        , this)).on("tokenize:clear", {}
        , t.proxy(function() {
            this.clear()
        }
        , this)).on("tokenize:remap", {}
        , t.proxy(function() {
            this.remap()
        }
        , this)).on("tokenize:select", {}
        , t.proxy(function(t, e) {
            this.focus(e)
        }
        , this)).on("tokenize:deselect", {}
        , t.proxy(function() {
            this.blur()
        }
        , this)).on("tokenize:search", {}
        , t.proxy(function(t, e) {
            this.find(e)
        }
        , this)).on("tokenize:paste", {}
        , t.proxy(function() {
            this.paste()
        }
        , this)).on("tokenize:dropdown:up", {}
        , t.proxy(function() {
            this.dropdownSelectionMove(-1)
        }
        , this)).on("tokenize:dropdown:down", {}
        , t.proxy(function() {
            this.dropdownSelectionMove(1)
        }
        , this)).on("tokenize:dropdown:clear", {}
        , t.proxy(function() {
            this.dropdownClear()
        }
        , this)).on("tokenize:dropdown:show", {}
        , t.proxy(function() {
            this.dropdownShow()
        }
        , this)).on("tokenize:dropdown:hide", {}
        , t.proxy(function() {
            this.dropdownHide()
        }
        , this)).on("tokenize:dropdown:fill", {}
        , t.proxy(function(t, e) {
            this.dropdownFill(e)
        }
        , this)).on("tokenize:dropdown:itemAdd", {}
        , t.proxy(function(t, e) {
            this.dropdownAddItem(e)
        }
        , this)).on("tokenize:keypress", {}
        , t.proxy(function(t, e) {
            this.keypress(e)
        }
        , this)).on("tokenize:keydown", {}
        , t.proxy(function(t, e) {
            this.keydown(e)
        }
        , this)).on("tokenize:keyup", {}
        , t.proxy(function(t, e) {
            this.keyup(e)
        }
        , this)).on("tokenize:tokens:reorder", {}
        , t.proxy(function() {
            this.reorder()
        }
        , this)).on("tokenize:tokens:add", {}
        , t.proxy(function(t, e, o, i) {
            this.tokenAdd(e, o, i)
        }
        , this)).on("tokenize:tokens:remove", {}
        , t.proxy(function(t, e) {
            this.tokenRemove(e)
        }
        , this))
    ...
    , o.prototype.init=function() {
        this.id=this.guid(), this.element.hide(), this.element.attr("multiple")||console.error("Attribute multiple is missing, tokenize2 can be buggy !"), this.dropdown=void 0, this.searchContainer=t('<li class="token-search" />'), this.input=t('<input autocomplete="off" />').on("keydown", {}
        , t.proxy(function(t) {
        ...
        , this)), 1===this.options.tokensMaxItems&&this.container.addClass("single"), this.options.sortable&&(void 0!==t.ui?(this.container.addClass("sortable"), this.tokensContainer.sortable( {
            items:"li.token", cursor:"move", placeholder:"token shadow", forcePlaceholderSize:!0, update:t.proxy(function() {
                this.trigger("tokenize:tokens:reorder")
            }
            , this), start:t.proxy(function() {
                this.searchContainer.hide()
            }
            , this), stop:t.proxy(function() {
    ...
    , o.prototype.tokenAdd=function(e, o, i) {
        if(e=this.escape(e), o=o||e, i=i||!1, this.resetInput(), void 0===e||""===e)return this.trigger("tokenize:tokens:error:empty"), this;
        ...
        if(t('option[value="'+e+'"]', this.element).length)t('option[value="'+e+'"]', this.element).attr("selected", "selected").prop("selected", !0);
        else if(i)this.element.append(t("<option selected />").val(e).html(o));
        else {
        ...
        return t('<li class="token" />').attr("data-value", e).append("<span>"+o+"</span>").prepend(t('<a class="dismiss" />').on("mousedown touchstart", {}
        , t.proxy(function(t) {
    ...
    , o.prototype.tokenRemove=function(e) {
    ...
    , o.prototype.focus=function(t) {
        t&&this.input.focus(), this.container.addClass("focus")
    }
    ...
    , o.prototype.keydown=function(e) {
        if("keydown"===e.type)switch(e.keyCode) {
            case i.BACKSPACE:if(this.input.val().length<1) {
                if(e.preventDefault(), t("li.token.pending-delete", this.tokensContainer).length>0)this.trigger("tokenize:tokens:remove", [t("li.token.pending-delete", this.tokensContainer).first().attr("data-value")]);
                else {
                    var o=t("li.token:last", this.tokensContainer);
                    o.length>0&&(this.trigger("tokenize:tokens:markForDelete", [o.attr("data-value")]), o.addClass("pending-delete"))
                }
                this.trigger("tokenize:dropdown:hide")
            }
            break;
            case i.TAB:e.shiftKey?this.tokensContainer.removeAttr("tabindex"):this.pressedDelimiter(e);
            break;
            case i.ENTER:this.pressedDelimiter(e);
            break;
            case i.ESCAPE:this.resetPending();
            break;
            case i.ARROW_UP:e.preventDefault(), this.trigger("tokenize:dropdown:up");
            break;
            case i.ARROW_DOWN:e.preventDefault(), this.trigger("tokenize:dropdown:down");
            break;
            case i.CTRL:this.control=!0;
            break;
            default:this.resetPending()
        }
        else e.preventDefault()
    }
    , o.prototype.keyup=function(t) {
        if("keyup"===t.type)switch(t.keyCode) {
            case i.TAB: case i.ENTER: case i.ESCAPE: case i.ARROW_UP: case i.ARROW_DOWN: case i.MAJ: break;
            case i.CTRL: this.control=!1;
            break;
            case i.BACKSPACE: default: this.input.val().length>0?this.trigger("tokenize:search", [this.input.val()]): this.trigger("tokenize:dropdown:hide")
        }
    ...
    , o.prototype.pressedDelimiter=function(e) {
    ...
    , o.prototype.dataSourceLocal=function(e) {
        var o=this.transliteration(e), i=[], n=(this.options.searchFromStart?"^": "")+this.escapeRegex(o), s=new RegExp(n, "i"), r=this;
        t("option", this.element).not(":selected, :disabled").each(function() {
            s.test(r.transliteration(t(this).html()))&&i.push( {
                value: t(this).attr("value"), text: t(this).html()
            }
            )
        }
        ), this.trigger("tokenize:dropdown:fill", [i])
    }
    , o.prototype.debounce=function(e, o) {
    ...
    , o.prototype.dropdownShow=function() {
        this.isDropdownOpen()||(t(".tokenize-dropdown").remove(), this.dropdown=t('<div class="tokenize-dropdown dropdown"><ul class="dropdown-menu" /></div>').attr("data-related", this.id), t("body").append(this.dropdown), this.dropdown.show(), this.dropdown.css("z-index", this.calculatezindex()+this.options.zIndexMargin), t(window).on("resize scroll", {}
        , t.proxy(function() {
            this.dropdownMove()
        }
    ...
    , o.prototype.calculatezindex=function() {
        ...
        if(!isNaN(parseInt(t.css("z-index")))&&parseInt(t.css("z-index"))>0&&(e=parseInt(t.css("z-index"))), e<1)for(;
        t.length;
        )if((t=t.parent()).length>0) {
            if(!isNaN(parseInt(t.css("z-index")))&&parseInt(t.css("z-index"))>0)return parseInt(t.css("z-index"));
            if(t.is("html"))break
        }
        return e
    }
    , o.prototype.dropdownHide=function() {
    ...
    , o.prototype.dropdownClear=function() {
        this.dropdown.find(".dropdown-menu li").remove()
    }
    , o.prototype.dropdownFill=function(e) {
        e&&e.length>0?(this.trigger("tokenize:dropdown:show"), this.trigger("tokenize:dropdown:clear"), t.each(e, t.proxy(function(e, o) {
            t("li.dropdown-item", this.dropdown).length<=this.options.dropdownMaxItems&&this.trigger("tokenize:dropdown:itemAdd", [o])
        }
        , this)), t("li.active", this.dropdown).length<1&&t("li:first", this.dropdown).addClass("active"), t("li.dropdown-item", this.dropdown).length<1?this.trigger("tokenize:dropdown:hide"):this.trigger("tokenize:dropdown:filled")):this.options.displayNoResultsMessage?(this.trigger("tokenize:dropdown:show"), this.trigger("tokenize:dropdown:clear"), this.dropdown.find(".dropdown-menu").append(t('<li class="dropdown-item locked" />').html(this.options.noResultsMessageText.replace("%s", this.input.val())))):this.trigger("tokenize:dropdown:hide"), t(window).trigger("resize")
    }
    , o.prototype.dropdownSelectionMove=function(e) {
        if(t("li.active", this.dropdown).length>0)if(t("li.active", this.dropdown).is("li:"+(e>0?"last-child": "first-child")))t("li.active", this.dropdown).removeClass("active"), t("li:"+(e>0?"first-child": "last-child"), this.dropdown).addClass("active");
        else {
    ...
    , o.prototype.dropdownAddItem=function(e) {
    ...
    , o.prototype.fixTarget=function(e) {
        var o=t(e);
        if(!o.data("value")) {
            var i=o.find("a");
    ...
    , o.prototype.dropdownItemFormat=function(e) {
        if(e.hasOwnProperty("text")) {
            ...
            return t("<a />").html(o).attr( {
                "data-value": e.value, "data-text": e.text
            }
            )
        }
    }
    , o.prototype.dropdownMove=function() {
        var t=this.tokensContainer.offset(), e=this.tokensContainer.outerHeight(), o=this.tokensContainer.outerWidth();
        t.top+=e, this.dropdown.css( {
            width: o
        }
        ).offset(t)
    }
    , o.prototype.isDropdownOpen=function() {
    ...
    , o.prototype.resetPending=function() {
